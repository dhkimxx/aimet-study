...
A8W8 AIMET QDQ의 정확도 손실은 주로 activation 쪽에서 발생한다. A16W8은 A8W8보다 크게 회복했고, all-activation-float ablation은 weight QDQ만 남긴 상태에서도 A16W8과 거의 같은 mAP를 보였다. 특히 YOLO head Conv output 24개만 float로 되돌려도 큰 회복이 있어 head activation encoding이 다음 최적화 대상이다.
...
| P0 | Head activation encoding 세분화 | layer별 민감도 표와 최적 skip/bitwidth 정책 |
