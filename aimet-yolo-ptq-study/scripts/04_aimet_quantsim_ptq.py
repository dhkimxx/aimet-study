"""Run AIMET QuantSim PTQ for YOLO ONNX and evaluate the exported model."""
...
def main() -> int:
    ...
    filename_prefix = f"{fp32_model.stem}.aimet_quantsim_int8"
    ...
    row = build_accuracy_row("C", "aimet_quantsim_ptq", True, aimet_model, metrics)
    append_csv_row(metrics_csv, ACCURACY_FIELDNAMES, row)

    details_path = output_dir / "metrics_aimet_quantsim_ptq.json"
